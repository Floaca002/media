...
class Settings(BaseSettings):
    ...
    # Radarr / Sonarr — automatic release search + grab for the "Download"
    # button's default flow. API keys are generated by each app itself on
    # first run (Settings > General in their dashboards) and optional here:
    # a magnet can still be pasted manually without them configured.
